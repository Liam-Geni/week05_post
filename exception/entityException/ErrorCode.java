package com.sparta.post03.exception.entityException;
...
public enum ErrorCode {
    ...
    REFRESH_TOKEN_IS_EMPTY("4012001", "Refresh Token is empty", "Refresh Token 이 없습니다."),
    ...
    POST_ID_NOT_FOUND("404", "Post id not exist", "존재하지 않는 게시글 ID 입니다."),
    COMMENT_ID_NOT_FOUND("404", "Comment id not exist", "존재하지 않는 댓글 ID 입니다. "),

//    POST_NOT_FOUND("404", "Post not exist", "존재하지 않는 게시글 입니다."),
//    COMMENT_NOT_FOUND("404", "Comment not found", "존재하지 않는 댓글 입니다."),
